...
pub async fn create_question(
    ...
    match question {
        ...
        Err(err) => {
            error!("Error on creating question: {}", err);
...
pub async fn read_questions(
    ...
    match questions {
        ...
        Err(err) => {
            error!("Error on getting questions: {}", err);
            Err(HandlerError::default_internal_error())
        }
    }
}
...
pub async fn delete_question(
    ...
    if result.is_err() {
        error!("Error on deleting question: {}", result.unwrap_err());
...
pub async fn create_answer(
    ...
    match answer {
        Ok(answer) => Ok(answer),
        Err(err) => {
            error!("Error on creating answer: {}", err);
...
pub async fn read_answers(
    ...
    match answers {
        ...
        Err(e) => {
            error!("Error on getting answer: {}", e);
            Err(HandlerError::default_internal_error())
        }
    }
}
...
pub async fn delete_answer(
    ...
    if result.is_err() {
        error!("Error on deleting answer: {}", result.unwrap_err());
        return Err(HandlerError::default_internal_error());
    }
